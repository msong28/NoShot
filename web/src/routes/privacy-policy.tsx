  ...
  return (
    <main className="mx-auto max-w-app p-four pb-16">
      ...
      <p className="mt-two text-sm text-text-secondary">
        ...
        and rate-limit logs (e.g. how many username searches you've made recently) used to keep the
        app usable, not to profile you.
      </p>

      <SectionHeader title="What we don't collect" />
      <p className="mt-two text-sm text-text-secondary">
        NoShot never holds or transfers real money, so we don't collect payment card details or bank
        information. There are no public follower counts or vanity metrics, and no ad network or
        third-party tracker embedded in the app.
      </p>
