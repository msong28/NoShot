  ...
  return (
    <main className="mx-auto max-w-app p-four pb-16">
      ...
      <p className="mt-three text-sm text-text-secondary">
        NoShot is for private, irreverent challenges between friends — a little chaos is part of the
        fun. These guidelines exist to keep that fun from tipping into something unsafe.
      </p>
